...
public class HistoryController {
    ...
    //FIXME! stupid, but don't have time... also destroyed when converting to Atom (Vondra)
    private void syncSnippets() {
        try {
            List<Snippet> snippets = new ArrayList<Snippet>(); //services.clipboard().getSnippets().values();
