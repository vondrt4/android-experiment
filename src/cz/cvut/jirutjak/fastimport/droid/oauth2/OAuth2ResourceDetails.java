...
public class OAuth2ResourceDetails implements Serializable {
    ...
    protected static final String DEFAULT_REDIRECT_URI = "http://www.example.cz"; //urn:ietf:wg:oauth:2.0:oob
    protected static final String RESPONSE_TYPE = "token"; //"code" - for Google's Installed application flow w/code and default redirect URI
